...
Default permissions for the plugin - allows all ad operations
...
- `allow-show-banner`
- `allow-hide-banner`
- `allow-prepare-interstitial`
- `allow-show-interstitial`
- `allow-prepare-rewarded`
- `allow-show-rewarded`
- `allow-prepare-rewarded-interstitial`
- `allow-show-rewarded-interstitial`
- `allow-prepare-app-open`
- `allow-show-app-open`
...
Enables the prepare_app_open command without any pre-configured scope.
...
`google-admob:deny-prepare-app-open`

</td>
<td>

Denies the prepare_app_open command without any pre-configured scope.
...
Enables the show_app_open command without any pre-configured scope.
...
`google-admob:deny-show-app-open`

</td>
<td>

Denies the show_app_open command without any pre-configured scope.
